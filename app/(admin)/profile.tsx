...
export default function AdminProfileScreen() {
    ...
    const userPhone = user?.phoneNumber || '+91 9894402440';
    const profilePhoto = user?.profilePhotoUri;

    // Order stats — computed from all total shop orders
    const stats = useMemo(() => {
    ...
    const settingsItems = [
        ...
        },
        {
            ...
            subtitle: 'View revenue and order trends',
            onPress: () => {
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
                    ...
                    <Animated.View entering={FadeInDown.delay(100).duration(500)} style={styles.statsRow}>
                        <View style={styles.statCard}>
                            ...
                            <Text style={styles.statLabel}>Total Shop Orders</Text>
                        </View>
                    ...
                    <View style={styles.footer}>
                        ...
                        <Text style={styles.footerText}>Barquee grill station HQ</Text>
                        ...
                        <View style={styles.drawerContainer}>
                            ...
                            <View style={styles.drawerNav}>
                                <TouchableOpacity style={styles.drawerNavItem} onPress={() => { setShowMenu(false); Alert.alert('Support', 'For any queries, reach us at:\n\n📧 ' + SHOP_EMAIL + '\n📞 ' + SHOP_PHONE); }}>
                                    ...
                                    <Text style={styles.drawerNavText}>Technical Support</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.drawerNavItem} onPress={() => { setShowMenu(false); Alert.alert('About Barquee grill station', 'Barquee grill station\n\nVersion: 1.0.0\n\n📍 Villianur Main Rd, Puducherry'); }}>
                                    <Ionicons name="information-circle-outline" size={22} color="#FF6A00" />
                                    <Text style={styles.drawerNavText}>View App Details</Text>
                                </TouchableOpacity>
                            </View>
                ...
                <Modal visible={showPhotoOptions} transparent animationType="slide" onRequestClose={() => setShowPhotoOptions(false)}>
                    <Pressable style={styles.modalOverlay} onPress={() => setShowPhotoOptions(false)}>
                        <Pressable style={styles.modalContent} onPress={(e) => e.stopPropagation()}>
                            ...
                            <Text style={styles.modalTitle}>Admin Photo</Text>
...
const styles = StyleSheet.create({
    ...
    statLabel: { color: '#757575', fontSize: 11, fontFamily: 'Inter_400Regular', textAlign: 'center' },
